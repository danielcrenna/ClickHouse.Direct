...
public class UInt16TypeTests
{
    ...
    public void ReadValue_SingleValue_ReturnsCorrectValue()
    {
        ...
        var reader = UInt16Type.Instance;
    ...
    {
        // Arrange: ushort.MaxValue (65535) in little-endian bytes
    ...
    {
        // Arrange: ushort.MinValue (0) in little-endian bytes
    ...
    {
        // Arrange
        var values = Enumerable.Range(1, count).Select(x => (ushort)x).ToArray();
    ...
    public void WriteValue_SingleValue_ProducesCorrectBytes()
    {
        ...
        var typeHandler = UInt16Type.Instance;
    ...
    public void WriteValue_MaxValue_ProducesCorrectBytes()
    {
        ...
        // Act
        typeHandler.WriteValue(writer, ushort.MaxValue);
    ...
    public void WriteValue_MinValue_ProducesCorrectBytes()
    {
        ...
        // Act
        typeHandler.WriteValue(writer, ushort.MinValue);
    ...
    [InlineData((ushort)54321)]
    public void RoundTrip_SingleValue_PreservesValue(ushort value)
    {
        // Arrange
        var typeHandler = UInt16Type.Instance;
        var writer = new ArrayBufferWriter<byte>();
    ...
    public void RoundTrip_LargeArray_PreservesAllValues()
    {
        ...
        // Act - Read
        var sequence = new ReadOnlySequence<byte>(buffer);
        var destination = new ushort[values.Length];
    ...
    public void Properties_ReturnCorrectValues()
    {
        ...
        // Assert
        Assert.Equal(0x02, typeHandler.ProtocolCode);
        Assert.Equal("UInt16", typeHandler.TypeName);
        Assert.True(typeHandler.IsFixedLength);
        Assert.Equal(2, typeHandler.FixedByteLength);
        Assert.Equal(typeof(ushort), typeHandler.ClrType);
    }
    ...
    {
        // Arrange & Act
        var typeHandler = new UInt16Type();
    ...
    public void SimdCapabilities_CustomInstance_UsesProvidedCapabilities()
    {
        ...
        // Act
        var typeHandler = new UInt16Type(customCapabilities);
        ...
        bool sse2, bool ssse3, bool avx2, bool avx512)
    {
        ...
        var values = Enumerable.Range(1, 100).Select(x => (ushort)x).ToArray();
        var writer = new ArrayBufferWriter<byte>();
